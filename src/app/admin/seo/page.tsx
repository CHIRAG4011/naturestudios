  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl bg-[#070D1E] border border-[#2563EB]/50 shadow-xl">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-[#D93D4A] to-[#B32633] text-[#F8FAFC] text-xs font-semibold shadow-lg shadow-[#D93D4A]/20 hover:brightness-110 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-5 rounded-2xl bg-[#070D1E] border border-[#172554]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono text-[#94A3B8]">SITEMAP STATUS</span>
            <CheckCircle2 className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="mt-2 text-lg font-bold text-[#F8FAFC]">Active & Dynamic</div>
          <p className="text-[11px] text-[#94A3B8] mt-1">Includes GFX, VFX, Jersey & Case Studies</p>
          <div className="mt-3 pt-3 border-t border-[#172554]/60 flex items-center justify-between">
            <a
              href="/sitemap.xml"
              target="_blank"
        ...
        <div className="p-5 rounded-2xl bg-[#070D1E] border border-[#172554]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono text-[#94A3B8]">ROBOTS.TXT</span>
            <CheckCircle2 className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="mt-2 text-lg font-bold text-[#F8FAFC]">Googlebot Allowed</div>
          <p className="text-[11px] text-[#94A3B8] mt-1">Protects /admin while indexing public hub</p>
          <div className="mt-3 pt-3 border-t border-[#172554]/60 flex items-center justify-between">
            <a
              href="/robots.txt"
              target="_blank"
        ...
        <div className="p-5 rounded-2xl bg-[#070D1E] border border-[#172554]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono text-[#94A3B8]">STRUCTURED DATA</span>
            <Sparkles className="w-4 h-4 text-amber-400" />
          </div>
          <div className="mt-2 text-lg font-bold text-[#F8FAFC]">4 JSON-LD Schemas</div>
          <p className="text-[11px] text-[#94A3B8] mt-1">WebSite, Organization, FAQ, Breadcrumbs</p>
          <div className="mt-3 pt-3 border-t border-[#172554]/60 flex items-center justify-between">
            <a
        ...
        <div className="p-5 rounded-2xl bg-[#070D1E] border border-[#172554]">
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono text-[#94A3B8]">GOOGLE SERP TEST</span>
            <Search className="w-4 h-4 text-blue-400" />
          </div>
          <div className="mt-2 text-lg font-bold text-[#F8FAFC]">Live Index Checker</div>
          <p className="text-[11px] text-[#94A3B8] mt-1">Check currently indexed URLs on Google</p>
          <div className="mt-3 pt-3 border-t border-[#172554]/60 flex items-center justify-between">
            <a
      ...
      <div className="p-6 rounded-3xl bg-[#070D1E] border border-[#172554] space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-syne text-base font-bold text-[#F8FAFC]">
              Google SERP Result Preview (How You Appear on Google)
            </h2>
          </div>
          <span className="text-xs font-mono text-[#94A3B8]">Updated for High CTR</span>
        </div>

        <div className="p-5 rounded-2xl bg-[#030712] border border-[#2A0609] space-y-2 max-w-3xl">
          <div className="flex items-center gap-2 text-xs text-[#9aa0a6]">
            <div className="w-4 h-4 rounded-full bg-[#070D1E] border border-[#172554] flex items-center justify-center text-[10px] text-[#F8FAFC]">
              N
            </div>
      ...
      <div className="p-6 rounded-3xl bg-[#070D1E] border border-[#172554] space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="p-5 rounded-2xl bg-[#030712] border border-[#0B132B] hover:border-[#2563EB] transition-all flex flex-col md:flex-row md:items-start justify-between gap-4"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-[#111C35] text-[#D93D4A] border border-[#2563EB]/50">
                      {step.badge}
                    </span>
                  </div>
                  ...
                  {step.codeSnippet && (
                    <div className="mt-2 p-2.5 rounded-lg bg-[#0C0102] border border-[#172554] font-mono text-[11px] text-[#F8FAFC] flex items-center justify-between">
                      <span className="truncate pr-2">{step.codeSnippet}</span>
                      <button
                        onClick={() => copyToClipboard(step.codeSnippet, 'meta')}
                        className="text-[10px] text-[#D93D4A] hover:text-[#F8FAFC] shrink-0 flex items-center gap-1 font-sans"
                      >
                        {copiedKey === 'meta' ? (
                          <>
                  ...
                  {step.copyValue && (
                    <div className="mt-2 flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-[#0B132B] hover:bg-[#111C35] border border-[#172554] text-xs text-[#F8FAFC] flex items-center gap-1.5 transition-colors"
                      >
                        {copiedKey === 'copyval' ? (
                          <>
              ...
              {step.actionUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="shrink-0 px-3.5 py-1.5 rounded-xl bg-[#0B132B] hover:bg-[#111C35] border border-[#172554] text-xs text-[#F8FAFC] font-medium flex items-center gap-1.5 transition-colors self-start"
                >
                  {step.actionText}
      ...
      <div className="p-6 rounded-3xl bg-[#070D1E] border border-[#172554] space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-[#030712] border border-[#0B132B] space-y-3">
            <div className="flex items-center gap-2">
      ...
      <div className="p-6 rounded-3xl bg-[#070D1E] border border-[#172554] space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3.5 rounded-xl bg-[#030712] hover:bg-[#200507] border border-[#0B132B] hover:border-[#2563EB] flex items-center justify-between text-xs text-[#F8FAFC] transition-all"
          >
